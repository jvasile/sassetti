...
(test rational-from-float-string
  (is (equal 2134561/10 (rational-from-float-string "213456.10")))
  (is (equal 213456 (rational-from-float-string "213456.0")))
  (is (equal 213456 (rational-from-float-string "213456.00")))
  (is (equal 21345601/100 (rational-from-float-string "213456.01")))
  (is (equal 21345699/100 (rational-from-float-string "213456.99")))
  (is (equal 10672800695763/50000000 (rational-from-float-string "213456.01391526")))
  (is (equal 21345699165119217619219821/100000000000000000000 (rational-from-float-string "213456.99165119217619219821")))
  )
(test dollars
