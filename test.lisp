...
(in-suite utils)
(test dollar
  (is (equal "123112" (dollar 123112.00)))
  (is (equal "123112.10" (dollar 123112.10)))
  (is (equal "123112.10" (dollar 123112.1)))
  (is (equal "123112.01" (dollar 123112.01)))
  (is (equal "123112.99" (dollar 123112.99))))
